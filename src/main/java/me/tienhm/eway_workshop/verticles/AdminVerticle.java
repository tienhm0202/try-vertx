...
public class AdminVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> startPromise) throws Exception {
    ...
    router.route(HttpMethod.DELETE, "/candidates/:candidate_id").handler(CandidateController::deleteCandidate);
    router.route(HttpMethod.PUT, "/candidates/:candidate_id").handler(CandidateController::updateCandidate);
    router.route(HttpMethod.GET, "/votes/").handler(VoteController::getResult);
